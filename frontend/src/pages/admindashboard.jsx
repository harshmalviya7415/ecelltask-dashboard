...
const Admindash = () => {
  ...
  if (!users) return 
    <div className="flex justify-center align-middle items-center text-[#e0fbfc] ">
      Loading...
    </div>
  ;
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-[#1c2541]  rounded-md">
        <div className="md:col-span-1 bg-[#3a506b] rounded-md m-10">
          ...
          <p className="text-center ">
            <button className="bg-[#3b7e7c] h-[40px] rounded-md text-[#e0fbfc] p-3 text-center items-center mt-14 mb-3">
              SHOW ALL TEMS
            </button>
          </p>
        </div>
      ...
      <div className=" grid grid-row-4 grid-flow-col gap-4  w-screen h-[400px]  overflow-x-auto ">
        {notidata.map((user, index) => (
          ...
          >
            ...
            <p className="m-4 text-[#e0fbfc]">{user.description}</p>
